                ...
                <div class="col-md-8">
                    <div class="row">
                        <div class="section-title">
                            <h2>Security Manager Login Form</h2>
                            <p>Please fill out the Login form below..</p>
                        </div>
                        <form action="ManagerLogin" method="post" id="contactForm" novalidate>
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <button class="btn btn-custom btn-lg"><a style="color: white" href="ManagerReg.jsp">Create New Account</a></button>
                        </form>
                    </div>
                </div>
