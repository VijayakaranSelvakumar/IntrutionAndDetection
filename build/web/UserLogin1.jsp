...
<!--                        <li><a href="#testimonials" class="page-scroll">Testimonials</a></li>
            ...
            <div class="container">
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <form action="UserLogin1" method="post" name="myform" id="contactForm" novalidate>
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <!--<div id="success"></div>-->
                            <button type="submit" class="btn btn-custom btn-lg" onclick="ReadCookie()"  >Login</button><br>
        ...
        <script type="text/javascript" src="js/main.js"></script>
               ...
               <script type="text/javascript">
  function send() {
    var link = 'mailto:arunjs46@gmail.com?subject=Message from '
