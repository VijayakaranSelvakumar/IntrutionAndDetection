            ...
            <div class="container"> 
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="SearchURL.jsp" class="page-scroll">Search URL</a></li>
            ...
            <div class="container">
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <form action="UserLogin" method="post" id="contactForm" novalidate>
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <!--<div id="success"></div>-->
                            <button type="submit" class="btn btn-custom btn-lg">Login</button><br>
                        ...
                        <button  class="btn btn-custom btn-lg"><a href="userReg.jsp"><i style="color: white">Create New Account</i></a></button>
