...
<html lang="en">
    ...
    <body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
            ...
            <div class="container"> 
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="UserProfile.jsp" class="page-scroll">View Profile</a></li>
                        <!--                        <li><a href="DNS.jsp" class="page-scroll">DNS Attack</a></li>
                                                <li><a href="Cookie.jsp" class="page-scroll">Cookie Poisoning</a></li>-->
                        <li><a href="UserLogin.jsp" class="page-scroll">Logout</a></li>
                        <!--                        <li><a href="#testimonials" class="page-scroll">Testimonials</a></li>
                                                <li><a href="#contact" class="page-scroll">Contact</a></li>-->
                    </ul>
                </div>
        ...
        <div id="about">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-md-6"> <img src="img/pro.png" class="img-responsive" alt=""> </div>
                    <div class="col-xs-12 col-md-6">
                        <div class="about-text">

                            <div style="margin-top: 200px"><table border="2px">
