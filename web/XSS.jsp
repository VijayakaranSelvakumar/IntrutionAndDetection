                ...
                <div class="col-md-8">
                    <div class="row">
                        <div class="section-title">
                            <h2>You are Under XSS Attack</h2>
                            <!--<p>Please fill out the Login form below..</p>-->
                        </div>
                        <div style="float: right">
                            <img src='img/xss.jpg' style="height: 400px;width: 600px;"> </img>
<!--                            <script>function a() {
                                    document.write("<img src='img/xss.jpg'></img>");
                                }
                                ;
                                window.onload = a;
                                alert("Hidden scripted image.");</script>-->
                        </div>




                        <button  class="btn btn-custom btn-lg"><a href="UserLogin1.jsp"><i style="color: white">Login Again</i></a></button>
