            ...
            <div class="container">
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <center><table border="2px" style="width: 600px">
                                <tr><th>Connected IP List</th></tr>
                                        ...
                                        <%
                                            ...
                                            try {
                                                ...
                                                PreparedStatement ps = con.prepareStatement(DbQuery.GETIP);
                                                ResultSet rs = ps.executeQuery();
                                                while (rs.next()) {

                                                    String ip = rs.getString("nodeAdd");


                                        %>
                                
                                        <tr><td> <h3 style="color: white"><%=ip%></h3> </td></tr>
                                ...
                                <center> <button  class="btn btn-custom btn-lg"><a href="GetVictimIp.jsp" style="color: white">Next</a></button></center>
